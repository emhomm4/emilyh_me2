        ...
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              My career has taken a few interesting turns — from experimental physics researcher to Android developer to software engineer to data scientist — and I wouldn&apos;t have it any other way. Each chapter has sharpened how I think, and today I bring that breadth to my work as a Senior Data Scientist at Microsoft, where I turn complex data into decisions that actually move the needle.
            </p>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
